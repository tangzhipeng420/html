...
print(js(7,"document.querySelectorAll('iframe').length"))
print(js(8,"document.getElementById('navframe_134')?'yes':'no'"))
print(js(9,"document.getElementById('ACCESS_NUMBER')?'yes':'no'"))
